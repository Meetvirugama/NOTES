...
class DockerProcessor:
    ...
    def determine_filename(self, image_path, generated_text):
        ...
        return f"generated_docker_{image_path.stem}.md"

    def process_image(self, image_path):
        print(f"Processing Docker Diagram: {image_path.name}...")
        ...
        try:
            ...
            print(f"✅ Success! Saved Docker notes to: {output_path}")
    ...
    def run(self):
        ...
        print(f"Found {len(images)} Docker images to process.\n")
        for img_path in images:
            self.process_image(img_path)
            
        print("\n🎉 Pipeline complete! Check the Docker output directory.")
