...
* **Chapter 10**: [Introduction to ANNs with Keras](../CH 10 : Introduction to Artificial Neural Networks with Keras/notes.md) - Core concepts of multilayer perceptrons, backpropagation, and basic Keras APIs.
