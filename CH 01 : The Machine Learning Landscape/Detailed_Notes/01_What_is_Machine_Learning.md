...
|---|---|---|
| Long list of rules | ML simplifies code, performs better | Spam filter |
| No known algorithm | ML finds a solution where humans can't | Speech recognition |
| Fluctuating environment | ML automatically adapts to new data | Stock prediction |
| Getting insights (Data Mining) | ML discovers hidden patterns | Customer segmentation |
