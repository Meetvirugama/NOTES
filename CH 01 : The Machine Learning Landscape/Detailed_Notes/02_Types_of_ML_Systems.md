...
> For Linear Regression, the training algorithm minimizes a cost function that measures the average distance between the model's predictions and the training labels.
