...
* **Chapter 12**: [Custom Models and Training with TensorFlow](../CH_12_Custom_Models_and_Training_with_TensorFlow/notes.md) - Explores custom loss functions, custom layers, tf.GradientTape, eagerness, and compiling graphs with @tf.function.
